...
This directory (`evaluation/benchmark/`) is an offline-first, public-ready selector microbenchmark. It does not modify Hermes core, the Switchyard plugin, configuration, live profiles, Windows components, or the private source repository.
