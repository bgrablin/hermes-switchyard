...
- Computer use is an experimental Windows-only pilot. It preserves Hermes dispatch and approval, filters sensitive or destructive controls, re-captures before actions, and returns `verified: false` for completion candidates.
